This function takes an input of two vectors that are equal in length and evenly spaced and returns an output that is the numerical integral of function 
